...
const World = {
    ...
    drawTile(ctx, id, x, y) {
        ...
        switch(id) {
            case 0: sx = 0; sy = 128; break;   // Floor (Home/Office)
            case 1: sx = 64; sy = 128; break;  // Wall Tiles
            case 2: sx = 32; sy = 192; break;  // Laptop/Office Desk
            case 3: sx = 0; sy = 192; break;   // Bed
            case 4: sx = 128; sy = 128; break; // Sidewalk
        }
